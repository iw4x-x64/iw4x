...
#ifndef LIBIW4X_IW4X_OPTIONS_HXX
#define LIBIW4X_IW4X_OPTIONS_HXX
...
namespace iw4x
{
  class options
  {
    ...
    options (int& argc,
             char** argv,
             bool erase = false,
             ::iw4x::cli::unknown_mode option = ::iw4x::cli::unknown_mode::fail,
             ::iw4x::cli::unknown_mode argument = ::iw4x::cli::unknown_mode::stop);
    ...
    print_usage (::std::ostream&,
                 ::iw4x::cli::usage_para = ::iw4x::cli::usage_para::none);

    // Implementation details.
    //
    protected:
    bool
    _parse (const char*, ::iw4x::cli::scanner&);

    private:
    bool
    _parse (::iw4x::cli::scanner&,
            ::iw4x::cli::unknown_mode option,
            ::iw4x::cli::unknown_mode argument);
...
#include <libiw4x/iw4x-options.ixx>
...
#endif // LIBIW4X_IW4X_OPTIONS_HXX
